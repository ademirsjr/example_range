...
const createClients = (customContext = {}, customOptions = {}) => {
    const mergedContext = Object.assign(Object.assign({}, context), customContext);
    const mergedOptions = Object.assign(Object.assign({}, options), customOptions);
    return {
        builder: new Builder_1.default(mergedContext, mergedOptions),
...
const [apps, router, workspaces, logger, events, billing, rewriter] = conf_1.getToken()
    ? [
        ...
        new api_1.Logger(context),
        new api_1.Events(context),
