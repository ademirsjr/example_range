...
const promptPolicies = () => __awaiter(void 0, void 0, void 0, function* () {
    return prompts_1.promptConfirm('Do you accept all the Terms?');
});
const checkBillingOptions = (app, billingOptions, force) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const confirm = yield promptPolicies();
    if (!confirm) {
        throw new errors_1.UserCancelledError();
    }
    logger_1.default.info('Starting to install app with accepted Terms');
    yield installApp(app, true, force);
    logger_1.default.debug('Installed after accepted terms');
});
exports.prepareInstall = (appsList, force) => __awaiter(void 0, void 0, void 0, function* () {
    if (appsList.length === 0) {
        return;
    }
    const app = manifest_1.validateApp(ramda_1.head(appsList));
    try {
        logger_1.default.debug('Starting to install app', app);
        if (app === 'vtex.billing' || ramda_1.head(app.split('@')) === 'vtex.billing') {
            yield legacyInstallApp(app);
        }
        else {
            const { code, billingOptions } = yield installApp(app, false, force);
            switch (code) {
                ...
                case 'check_terms':
                    ...
                    yield checkBillingOptions(app, JSON.parse(billingOptions), force);
            }
        }
    ...
    yield exports.prepareInstall(ramda_1.tail(appsList), force);
});
...
exports.default = (optionalApp, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield utils_1.validateAppAction('install', optionalApp);
