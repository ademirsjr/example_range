...
const streamToString = require("get-stream");
...
function webSocketTunnelHandler(host, path) {
    ...
    return (socket) => {
        ...
        ws.on('unexpected-response', (_, res) => __awaiter(this, void 0, void 0, function* () {
            end();
            const errMsg = getErrorMessage(yield streamToString(res));
